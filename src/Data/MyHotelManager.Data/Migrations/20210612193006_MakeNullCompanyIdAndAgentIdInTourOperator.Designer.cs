...
namespace MyHotelManager.Data.Migrations
{
    ...
    [Migration("20210612193006_MakeNullCompanyIdAndAgentIdInTourOperator")]
    partial class MakeNullCompanyIdAndAgentIdInTourOperator
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyHotelManager.Data.Models.Payment", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MyHotelManager.Data.Models.TourOperator", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("TourOperatorAgentId")
                        .HasColumnType("int");

                    b.Property<int?>("TourOperatorCompanyId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TourOperatorAgentId");
            ...
            modelBuilder.Entity("MyHotelManager.Data.Models.TourOperatorAgent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("TourOperatorAgents");
                });

            modelBuilder.Entity("MyHotelManager.Data.Models.TourOperatorCompany", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyHotelManager.Data.Models.TourOperator", b =>
                {
                    ...
                    b.HasOne("MyHotelManager.Data.Models.TourOperatorAgent", "Agent")
                        .WithMany()
                        .HasForeignKey("TourOperatorAgentId");

                    b.HasOne("MyHotelManager.Data.Models.TourOperatorCompany", "Company")
                        .WithMany()

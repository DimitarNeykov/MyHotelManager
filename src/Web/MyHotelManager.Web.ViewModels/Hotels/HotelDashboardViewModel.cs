namespace MyHotelManager.Web.ViewModels.Hotels
{
    ...
    public class HotelDashboardViewModel : IMapFrom<Hotel>
    {
        ...
        public int FebruaryReservations => this.Rooms.Sum(r => r.Reservations
            .Count(r => r.ReturnDate.Year == DateTime.Now.Year && r.ReturnDate.Month == 2 && r.CancelDate == null && r.IsDeleted == true));

        public int MarchReservations => this.Rooms.Sum(r => r.Reservations
            .Count(r => r.ReturnDate.Year == DateTime.Now.Year && r.ReturnDate.Month == 3 && r.CancelDate == null && r.IsDeleted == true));

        public int AprilReservations => this.Rooms.Sum(r => r.Reservations
            .Count(r => r.ReturnDate.Year == DateTime.Now.Year && r.ReturnDate.Month == 4 && r.CancelDate == null && r.IsDeleted == true));

        public int MayReservations => this.Rooms.Sum(r => r.Reservations
            .Count(r => r.ReturnDate.Year == DateTime.Now.Year && r.ReturnDate.Month == 5 && r.CancelDate == null && r.IsDeleted == true));

        public int JuneReservations => this.Rooms.Sum(r => r.Reservations
            .Count(r => r.ReturnDate.Year == DateTime.Now.Year && r.ReturnDate.Month == 6 && r.CancelDate == null && r.IsDeleted == true));

        public int JulyReservations => this.Rooms.Sum(r => r.Reservations
            .Count(r => r.ReturnDate.Year == DateTime.Now.Year && r.ReturnDate.Month == 7 && r.CancelDate == null && r.IsDeleted == true));

        public int AugustReservations => this.Rooms.Sum(r => r.Reservations
            .Count(r => r.ReturnDate.Year == DateTime.Now.Year && r.ReturnDate.Month == 8 && r.CancelDate == null && r.IsDeleted == true));

        public int SeptemberReservations => this.Rooms.Sum(r => r.Reservations
            .Count(r => r.ReturnDate.Year == DateTime.Now.Year && r.ReturnDate.Month == 9 && r.CancelDate == null && r.IsDeleted == true));

        public int OctoberReservations => this.Rooms.Sum(r => r.Reservations
            .Count(r => r.ReturnDate.Year == DateTime.Now.Year && r.ReturnDate.Month == 10 && r.CancelDate == null && r.IsDeleted == true));

        public int NovemberReservations => this.Rooms.Sum(r => r.Reservations
            .Count(r => r.ReturnDate.Year == DateTime.Now.Year && r.ReturnDate.Month == 11 && r.CancelDate == null && r.IsDeleted == true));

        public int DecemberReservations => this.Rooms.Sum(r => r.Reservations
            .Count(r => r.ReturnDate.Year == DateTime.Now.Year && r.ReturnDate.Month == 12 && r.CancelDate == null && r.IsDeleted == true));
    }
}
